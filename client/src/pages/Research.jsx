    ...
    <div className="research-container py-5">
      <div className="container">
        ...
        <div className="text-center mb-5">
          ...
          <p className="text-muted fw-medium" style={{ maxWidth: '750px', margin: '0 auto' }}>
            ...
            <div className="card glass-card p-4 border border-secondary border-opacity-10 sticky-top" style={{ top: '80px', zIndex: 5 }}>
              ...
              <div className="d-flex flex-column gap-2">
                <button
                  ...
                  className={`btn btn-sm text-start py-2 px-3 rounded btn-filter-custom ${!category ? 'active' : ''}`}
                >
                  All Research
                </button>
                {categories.map((cat) => (
                  <button
                    ...
                    className={`btn btn-sm text-start py-2 px-3 rounded btn-filter-custom ${category === cat ? 'active' : ''}`}
                  >
                    {cat}
                  </button>
                ))}
